...
- Brand new projects (use architecture planning agents instead)
- Projects already under active modernization
- Frameworks or platforms without significant business logic
...
- **Report progress periodically during analysis** (e.g., "Completed: 5/12 features analyzed")
...
- Use file_search to find all project files (.csproj, .sln, package.json, requirements.txt, etc.)
