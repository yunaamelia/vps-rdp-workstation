...
## OVERVIEW
Installs Zsh, clones Oh My Zsh via git (not installer script), configures `.zshrc` (theme, plugins, PATH), sets up Konsole with Nordic colorscheme and Hack Nerd Font.
...
└── templates/      # konsole-profile.j2 (Nordic + font config)
```
...
| **Konsole colorscheme** | `tasks/main.yml:134-142` | Configures Nordic profile |
